...
DAR       = os.path.join(ROOT, "ledger", "contracts", ".daml", "dist", "cloakrfq-contracts-v2-0.2.0.dar")
TEST_DAR  = os.path.join(ROOT, "ledger", "test", ".daml", "dist", "cloakrfq-test-v2-0.2.0.dar")  # CIP-56 token mocks (Phase 2/3)
...
def main():
    ...
    cfg = {"jsonApiUrl": LEDGER, "packageRef": "#cloakrfq-contracts-v2", "userId": USER_ID, "parties": parties}
